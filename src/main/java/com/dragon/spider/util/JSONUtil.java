...
import static com.dragon.spider.util.BeanUtil.requireNonNull;
import static com.dragon.spider.util.StrUtil.isBlank;
...
public abstract class JSONUtil {
    ...
    public static final SerializerFeature[] DEFAULT_FORMAT = { SerializerFeature.WriteDateUseDateFormat, SerializerFeature.WriteEnumUsingToString,
        SerializerFeature.WriteNullStringAsEmpty, SerializerFeature.QuoteFieldNames, SerializerFeature.SkipTransientField,
