...
CREATE TABLE `wx`.`wx_dic_region` (
  ...
  `parentcode` VARCHAR(20) NULL COMMENT '父地区代码，根地区(如省)该字段为null',
  PRIMARY KEY (`code`))
...
alter table wx_account_statusinfo add index wx_statusinfo_wxaccount(wxaccount);
